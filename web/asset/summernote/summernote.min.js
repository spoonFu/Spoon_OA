    ...
    var h, i = {
        ...
        options: {
            ...
            onImageUpload: function(files, editor, $editable){
                ...
                if(!filename){$(".note-alarm").remove();return;}
                ...
                data.append("token","DDJfeZyUkr8qBJhE0_7pyN__hTYqxZsMVEB1jSGq:tQH0QsqkYvWAcpSUlVg3_ldRcZw=:eyJzY29wZSI6ImZvb3Nwb29uOlNQT09OX0tFWSIsImRlYWRsaW5lIjoxNDQwMzA0OTg4fQ==");
                $.ajax({
                    data: data,
                    type: "POST",
                    ...
                    success: function(data) {
                        ...
                        editor.insertImage($editable, "http://foospoon.qiniudn.com/"+data['key']);
