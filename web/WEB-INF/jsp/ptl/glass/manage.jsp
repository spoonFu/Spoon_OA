        ...
        <div id="content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">眼镜产品</h3>
                </div>
                <div class="panel-body">
                    <!-- 查询表单开始 -->
                    <form class="form-inline query-form" modelAttribute="condition" action="manage.do" method="post"
                          role="form">
                        <div class="form-group">
                            <label for="productName">名称</label>
                            <input type="text" id="productName" name="product.name" class="form-control" placeholder="名称">
                        </div>
                        <div class="btn-group">
                    ...
                    <!-- 查询表单结束 -->
                    <!-- 数据展示表开始 -->
                    <%@ include file="/WEB-INF/jsp/ptl/glass/result.jsp" %>
                    <!-- 数据展示表结束 -->
                </div>
            </div>
            <!-- 面板结束 -->
