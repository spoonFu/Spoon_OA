...
public class MyBaseController {
	...
	protected void setMenu(Model model, HttpServletRequest req) {
		...
		if (resource==null) {
			logger.warn("未找到'"+url+"'对应资源，HELP!!!");
			return;
		}
		model.addAttribute("menuId", resource.getMenuid());
	 ...
	 * @param req
	 */
	protected void menuSet(Model model, HttpServletRequest req) {
		String url = req.getRequestURL().toString(), menuId = "";
